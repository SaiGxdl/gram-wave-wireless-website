...
export default function Footer() {
  ...
  // Scoped preview flag — see Navbar.tsx for the same pattern.
      ...
      <footer className="w-full bg-[#F6F7F9] border-t border-[#E4E7EC] py-16 md:py-24 mt-auto relative z-10">
        <div className="max-content-width grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 w-full">
          ...
          <div className="md:col-span-5 space-y-6">
            <Link href="/home-test" className="flex items-center space-x-3 group">
              <div className="relative h-8 w-8 shrink-0 transition-transform group-hover:scale-105">
                <Image src="/logo-emblem.png" alt="Gramwave Wireless Emblem" fill sizes="32px" className="object-contain" />
              </div>
          ...
          <div className="md:col-span-2 space-y-4">
            <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0B0F19]">Navigation</h3>
            <ul className="space-y-3 text-xs">
              {[
                { href: "/home-test", label: "Home" },
                { href: "/adaptive-wave", label: "Adaptive Wave" },
                { href: "/research-ip", label: "Research & IP" },
                { href: "/roadmap", label: "Roadmap" },
              ].map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-[#5B6472] hover:text-[#0B0F19] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] rounded-sm">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="md:col-span-3 space-y-4">
            <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0B0F19]">Join & Contact</h3>
            <ul className="space-y-3 text-xs">
              <li>
                <Link href="/careers" className="text-[#5B6472] hover:text-[#0B0F19] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] rounded-sm">
                  Careers & Internships
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[#5B6472] hover:text-[#0B0F19] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] rounded-sm">
                  Contact & FAQ
                </Link>
              </li>
          ...
          {/* Legal */}
          <div className="md:col-span-2 space-y-4">
            <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0B0F19]">Legal Policies</h3>
            <ul className="space-y-3 text-xs">
              <li>
                <Link href="/privacy" className="text-[#5B6472] hover:text-[#0B0F19] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] rounded-sm">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-[#5B6472] hover:text-[#0B0F19] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] rounded-sm">
                  Terms of Use
                </Link>
              </li>
              <li>
                <Link href="/disclaimer" className="text-[#5B6472] hover:text-[#0B0F19] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] rounded-sm">
                  Disclaimer
                </Link>
              </li>
            </ul>
  ...
  return (
    <footer className="w-full bg-[#030712] border-t border-card-border/40 py-16 md:py-24 mt-auto relative z-10">
      <div className="max-content-width grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 w-full">
        ...
        <div className="md:col-span-2 space-y-4">
          <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Navigation</h3>
          <ul className="space-y-3 text-xs">
            <li>
        ...
        <div className="md:col-span-3 space-y-4">
          <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Join & Contact</h3>
          <ul className="space-y-3 text-xs">
            <li>
        ...
        <div className="md:col-span-2 space-y-4">
          <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Legal Policies</h3>
          <ul className="space-y-3 text-xs">
            <li>
